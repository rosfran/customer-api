...
public enum SearchOperation {
    ...
    CONTAINS, DOES_NOT_CONTAIN, EQUAL, NOT_EQUAL, STARTS_WITH, DOES_NOT_START_WITH, ENDS_WITH,
    DOES_NOT_END_WITH, NUL, NOT_NULL, GREATER_THAN, GREATER_THAN_EQUAL, LESS_THAN, LESS_THAN_EQUAL,
    ANY, ALL;

    public static final String[] SIMPLE_OPERATION_SET = {"cn", "nc", "eq", "ne", "sw", "sn", "ew",
    ...
    public static SearchOperation getSimpleOperation(final String input) {
        switch (input){
            ...
            case "sn": return DOES_NOT_START_WITH;
